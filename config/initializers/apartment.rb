...
Apartment.configure do |config|
  ...
  # Exclude all models except the ones that are namespaced with Multitenanted.
  # The entire app is to work in the public schema apart from a few multitenanted models
  # for data security / access reasons. This means the tenants will act like app backends for people
  ...
  # end
  #
  config.tenant_names = lambda { Backend.pluck :subdomain }
...
# Switch tenant if theyre on a Multitenanted:: namespaced controller.
